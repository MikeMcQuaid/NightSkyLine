                ...
                <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
                    ...
                    <?php else : ?>
                        ...
                        <p><input type="text" name="author" id="author" value="<?php echo $comment_author; ?>" size="22" tabindex="1" <?php if ($req) _e('required="required"'); ?>/>
                            <label for="author"><small>Name <?php if ($req) _e('(required)'); ?></small></labbypost
                            <p><input type="email" name="email" id="email" value="<?php echo $comment_author_email; ?>" size="22" tabindex="2" <?php if ($req) _e('required="required"'); ?>/>
                                ...
                                <p><textarea name="comment" id="commentinput" cols="40" rows="10" tabindex="4"></textarea></p>

                                <p>If this is your first comment I will need to manually authorise you. Please be patient and thanks for reading!</p>
